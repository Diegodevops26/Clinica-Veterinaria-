  ...
  <header class="main-header">
    ...
    <nav class="main-header__nav-bar">
      ...
      <a class="main-header__nav-btn" href="Consultas.php">
        <img class="main-header__nav-icon svg" src="../icon/veterinario.svg">
        Consultas
      </a>
  ...
  <div class="main-body perfil-body">
    ...
    <span class="perfil-edit" id="perfil-edit">
      <a href="EditarPerfil.php">
        <img class=" svg " src="../icon/profile.svg">
      </a>
    </span>
        ...
        <div class="perfil-widget">
          ...
          <div class="card" id="dadosPessoais">
            ...
            <form action="">
              ...
              <br>
              <input type="date" id="bday" max="2020-12-31" value="<?php echo htmlspecialchars($_SESSION['dtNascimento']); ?>"><br>
              <br>
...
<script>
  ...
  function salvaBanco() 
  {
        ...
        var cpf = document.getElementByld("cpf").value;
